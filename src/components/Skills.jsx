...
const Skills = () => {
  return (
    <div name="skills" className="w-full h-screen bg-[#eceff9] text-gray-800">
      {/* {Container} */}
      <div className="max-w-[1000px] mx-auto p-16 flex flex-col justify-center w-full h-full">
        <div>
          <p className="text-4xl inline border-b-4 border-[#1F6492]">Skills</p>
          <p className="py-4">
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8">
          ...
          <div className="bg-[#f6f7fa] shadow-md shadow-[#040c16] hover:scale-110 duration:500">
            <img className="w-20 my-4 mx-auto" src={Github} alt="GitHub icon" />
            <p className="my-4">GITHUB</p>
          </div>
          <div className="bg-[#f6f7fa] shadow-md shadow-[#040c16] hover:scale-110 duration:500">
            <img className="w-20 my-4 mx-auto" src={Python} alt="Python icon" />
            <p className="my-4">PYTHON</p>
          </div>
          <div className="bg-[#f6f7fa] shadow-md shadow-[#040c16] hover:scale-110 duration:500">
            <img className="w-20 my-4 mx-auto" src={SQLite} alt="SQLite icon" />
          ...
          <div className="bg-[#f6f7fa] shadow-md shadow-[#040c16] hover:scale-110 duration:500">
            <img className="w-20 my-4 mx-auto" src={Docker} alt="Docker icon" />
